...
struct NppResizeSurfaceRGB_Impl final : ResizeSurface_Impl {
  ...
  TaskExecStatus Execute(Surface &source) {
    ...
    const bool is_upscale = (oDstRectROI.width > oSrcRectROI.width) &&
                            (oDstRectROI.height > oSrcRectROI.height);
    int eInterpolation = is_upscale ? NPPI_INTER_LANCZOS : NPPI_INTER_SUPER;
